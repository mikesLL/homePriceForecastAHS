...
function [ N_negeq, N_paid_off, N_negeq_cfp, N_negeq_cfn, med_pmt_inc ] = ...
...
rent_i = a1_ds.VALUE ./ param.med_val .* param.P_HR;      % individual rent

N_negeq_cfp = sum(  and( a1_ds.VALUE < MBAL, rent_i >= PMT ) );
N_negeq_cfn = sum( and( a1_ds.VALUE < MBAL, rent_i < PMT ) );

% create index for new homeowners
idx_newho = ( a1_ds.YRMOR_est >= (CURR_YEAR - 1 ) );

med_pmt_inc = median( PMT(idx_newho) ./ a1_ds.ZINC2(idx_newho) );
