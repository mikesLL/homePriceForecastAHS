function [ risk_idx ] = gen_risk_idx(param, city_str, ds_use, newhouse_flat )

save('save_gen_risk_idx2');
...
for id = 1:length(ds_use)
    ...
    if ~isempty(ds_id)
        ...
        N_nat_buyers = sum( param.LTI/param.APR*a1_ds.ZINC2 >= param.med_val  );
